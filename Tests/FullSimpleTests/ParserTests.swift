...
class ParserTests: XCTestCase {
  ...
  func testAbsBaseType() {
    ...
    check(input: "(\\x:bool.x) x", expectedTerm: expected)
  }
  ...
  func testLetSimple() {
    ...
    let expected: Term = .Let(pattern: .Variable(name: "x", index: 0), argument: t1, body: t2)
  ...
  func testLetApp() {
    ...
    let expected: Term = .Let(pattern: .Variable(name: "e", index: 0), argument: t1, body: t2)
  ...
  func testTupleProjection() {
    check(input: "{true}.1", expectedTerm: .Let(pattern: .Record(["1":.Variable(name: "x", index: 0)]), argument: .Tuple(["1":.True]), body: .Variable(name: "x", index: 0)))
  }
  ...
  func testPatternMatching() {
    let expected: Term = .Let(pattern: .Record(["1":.Variable(name: "x", index: 0), "2":.Variable(name: "y", index: 1)]), argument: .Tuple(["1":.Zero, "2":.True]), body: .Variable(name: "x", index: 1))
  ...
  func testLetNested() {
    ...
    let expected: Term = .Let(pattern: .Variable(name: "x", index: 0), argument: .Zero, body: outer)
  ...
  func testLetVariablePattern() {
    let inner: Term = .Let(pattern: .Record(["1":.Variable(name: "x", index: 0)]), argument: .Variable(name: "x", index: 0), body: .Variable(name: "x", index: 0))
    let outer: Term = .Let(pattern: .Variable(name: "x", index: 0), argument: .Tuple(["1":.Zero, "2":.True]), body: inner)
    print(outer)
  ...
  func testLetrec() {
    ...
    check(input: "letrec z: bool->bool = (\\x:bool.x) in z", expectedTerm: .Let(pattern: .Variable(name: "z", index: 0), argument: argument, body: body))
  }
