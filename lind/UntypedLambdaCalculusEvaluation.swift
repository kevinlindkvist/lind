...
private typealias NameLookup = [Int:LCTerm]

func evaluate(term: LCTerm) -> LCTerm {
...
private func evaluate(term: LCTerm, _ context: NameLookup) -> LCTerm? {
  switch term {
...
private func isValue(term: LCTerm, _ context: NameLookup) -> Bool {
  switch term {
...
private func shift(d: Int, _ c: Int, _ t: LCTerm) -> LCTerm {
  switch t {
...
private func substitute(j: Int, _ s: LCTerm, _ t: LCTerm, _ c: Int) -> LCTerm {
  switch t {
...
private func termSubstop(s: LCTerm, _ t: LCTerm) -> LCTerm {
